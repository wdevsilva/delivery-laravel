...
class CarrinhoController extends Controller
{
    ...
    protected $fidelidadeRepository;
...
<?php
    ...
    {
        $minimo = $this->configRepository->get_valor_minimo_pedido();
    ...
    public function aplicar_pontos()
    {
        ...
        try {
            ...
            $saldo_data = $this->fidelidadeRepository->get_saldo_cliente(session('__CLIENTE__ID__'));
