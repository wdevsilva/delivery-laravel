                            ...
                            <div class="content">
                                <form name="form-novo" id="form-novo" action="<?php echo $baseUri; ?>/usuario/gravar/" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="usuario_nome" id="usuario_nome" class="form-control" placeholder="Informe o nome completo" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <span class="text-danger">*</span>
                                        <input type="email" name="usuario_email" id="usuario_email" class="form-control" placeholder="informe um usuário válido" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Login</label>
                                        <span class="text-danger">*</span>
                                        <input type="text" name="usuario_login" id="usuario_login" class="form-control" placeholder="Login do usuário ex: admin ou operador01" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Senha</label>
                                        <span class="text-danger">*</span>
                                        <input type="password" name="usuario_senha" id="usuario_senha" class="form-control" placeholder="Informe uma senha de acesso" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group hide">
                                        ...
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            ...
                                            <div>
                                                <span class="btn btn-default btn-file"><span class="fileinput-new">Selecionar Foto</span><span class="fileinput-exists">Alterar</span>
