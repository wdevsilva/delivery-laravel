            ...
            <table class="printer-ticket">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <?php 
                        // Processa e exibe extras formatados por categoria
                        if (!empty($cart->lista_item_extra)) {
                            ...
                            foreach ($extras_lines as $line) {
                                ...
                                if (stripos($line, 'massa:') !== false) {
                                    $line = preg_replace('/massa:/i', 'Massa:', $line);
                                    echo '<tr><td style="width: 20px; font-size: 12px;">&nbsp;</td><td style="width: 500px; font-size: 12px;"><small style="padding-left: 10px;"><b>' . $line . '</b></small></td><td style="width: 100px; font-size: 12px"></td></tr>';
                                } elseif (stripos($line, 'molho:') !== false) {
                                    $line = preg_replace('/molho:/i', 'Molho:', $line);
                                    echo '<tr><td style="width: 20px; font-size: 12px;">&nbsp;</td><td style="width: 500px; font-size: 12px;"><small style="padding-left: 10px;"><b>' . $line . '</b></small></td><td style="width: 100px; font-size: 12px"></td></tr>';
                                } elseif (stripos($line, 'temperos:') !== false) {
                                    $line = preg_replace('/temperos:/i', 'Temperos:', $line);
                                    echo '<tr><td style="width: 20px; font-size: 12px;">&nbsp;</td><td style="width: 500px; font-size: 12px;"><small style="padding-left: 10px;"><b>' . $line . '</b></small></td><td style="width: 100px; font-size: 12px"></td></tr>';
                                } elseif (stripos($line, 'borda:') !== false || stripos($line, 'bordas:') !== false) {
                                    $line = preg_replace('/bordas?:/i', 'Borda:', $line);
                                    echo '<tr><td style="width: 20px; font-size: 12px;">&nbsp;</td><td style="width: 500px; font-size: 12px;"><small style="padding-left: 10px;"><b>' . $line . '</b></small></td><td style="width: 100px; font-size: 12px"></td></tr>';
                                } elseif (stripos($line, 'adicionais:') !== false) {
                                    // Para adicionais, calcula o valor total
                                    $valor_adicionais = 0;
                                    if (preg_match_all('/\(\+R\$\s*([\d.,]+)\)/u', $line, $matches)) {
                                        foreach ($matches[1] as $valStr) {
                                            $val = floatval(str_replace(',', '.', trim($valStr)));
                                            $valor_adicionais += $val;
                                        }
                                    }
                                    $total_adicionais = $valor_adicionais * $cart->lista_qtde;
                                    $line = preg_replace('/adicionais:/i', 'Adicionais:', $line);
                                    echo '<tr><td style="width: 20px; font-size: 12px;">&nbsp;</td><td style="width: 500px; font-size: 12px;"><small style="padding-left: 10px;"><b>' . $line . '</b></small></td><td style="width: 100px; font-size: 12px">R$' . Currency::moeda($total_adicionais) . '</td></tr>';
                                } elseif (stripos($line, 'ingredientes:') !== false) {
                                    $line = preg_replace('/ingredientes:/i', 'Ingredientes:', $line);
                                    echo '<tr><td style="width: 20px; font-size: 12px;">&nbsp;</td><td style="width: 500px; font-size: 12px;"><small style="padding-left: 10px;"><b>' . $line . '</b></small></td><td style="width: 100px; font-size: 12px"></td></tr>';
                                } elseif (stripos($line, 'itens grátis:') !== false || stripos($line, 'itens gratis:') !== false) {
                                    // Itens grátis
                                    $line = preg_replace('/itens\s+gr[aá]tis:/i', 'Itens Grátis:', $line);
                                    echo '<tr><td style="width: 20px; font-size: 12px;">&nbsp;</td><td style="width: 500px; font-size: 12px;"><small style="padding-left: 10px;"><i>' . $line . '</i></small></td><td style="width: 100px; font-size: 12px"></td></tr>';
                                }
                            }
                        } ?>
                        <?php
