...
<body class="animated">
                    ...
                    <div class="content">
                        ...
                        <?php if (!$mesa): ?>
                            <div class="alert alert-error">
                                ...
                                <br>
                                <a href="<?= $baseUri ?>/mesa/lista" class="btn btn-back btn-lg">
                                        ...
                                        <div class="form-card-body">
                                            <form method="POST" action="<?= $baseUri ?>/admin/mesa/gravar" id="editForm">
                                                ...
                                                <div style="margin-top: 30px;">
                                                    ...
                                                    <a href="<?= $baseUri ?>/mesa/detalhes/<?= $mesa->mesa_id ?>" class="btn btn-action btn-details">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (errorParam) {
                alert('Erro: ' + decodeURIComponent(errorParam));
