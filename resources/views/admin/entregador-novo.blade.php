...
<body class="animated">
    <div id="cl-wrapper">
        ...
        <div class="container-fluid" id="pcont">
            ...
            <div class="cl-mcont">
                <h3 class="text-center">Cadastrar Entregador</h3>
                    ...
                    <div class="content">
                        <form action="<?php echo $baseUri; ?>/entregador/gravar/" method="post" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" name="entregador_nome" id="entregador_nome" class="form-control" placeholder="Informe o nome do contato responsável" required>
                            </div>
                            <div class="form-group">
                                <label for="entregador_cpf">CPF <small>(opcional)</small></label>
                                <input type="text" data-mask="cpf" name="entregador_cpf" id="entregador_cpf" class="form-control" placeholder="Informe o número do documento">
                            </div>
                            <div class="form-group">
                                <label for="entregador_fone">Celular</label>
                                <input type="text" data-mask="cell" placeholder="(99) 99999-9999" name="entregador_fone" id="entregador_fone" class="form-control">
                            </div>
                            <p class="text-center">
