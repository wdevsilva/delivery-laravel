        ...
        <div class="container-fluid" id="pcont">
            ...
            <div class="cl-mcont">
                <div class="block-flat">
                    ...
                    <div class="header">
                        <h3>Configuração Taxa por item</h3>
                        <h5>Configure uma taxa fixa para cada item vendido. O valor total da taxa será calculado multiplicando esta taxa pela quantidade de itens no pedido.</h5>
                    </div>
                    <div class="content">
                        <form action="<?php echo $baseUri; ?>/configuracao/gravarTaxaCartaoItem/" method="POST">
                            <input type="hidden" name="id[]" value="<?= $data['empresa']->config_id ?>">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="taxa_valor">Valor da Taxa R$ <span class="text-danger">*</span></label>
                                        <input type="text" name="taxa_valor" id="taxa_valor" class="form-control money" placeholder="Informe o valor da taxa" value="<?= $data['empresa']->config_taxa_valor ?>" required>
                                    </div>
                                </div>
                            </div>
