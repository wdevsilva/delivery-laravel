...
if (!empty($config->config_foto)) {
    ...
    $logoFullPath = __DIR__ . '/../../../assets/logo/' . $_SESSION['base_delivery'] . '/' . $logoFile;
    if (file_exists($logoFullPath)) {
        $logoPath = '/assets/logo/' . $_SESSION['base_delivery'] . '/' . $logoFile;
    }
}

// Se não tiver logo da empresa, usar logo padrão
if (empty($logoPath)) {
    $logoPath = '/assets/img/favicons/favicon-144x144.png';
}
