@php
    $current = parse_url(request()->getRequestUri(), PHP_URL_PATH);
@endphp
    ...
    <div data-v-42af03df="" class="menu-container__wrapper category-cards">
        ...
        <div data-v-0c8898ec="" data-v-42af03df="">
            <div data-v-0c8898ec="" class="mi-container flex justify-around router-link-active pt-1 voltarFooter" data-testid="router-link-menu">
                <a href="{{ url('/') }}" data-v-1267300e="" data-v-0c8898ec="" data-testid="span-menu"
        ...
        @if($current != '/pedido/')
            ...
            <div data-v-0c8898ec="" data-v-42af03df="">
                <div data-v-0c8898ec="" class="mi-container flex justify-around router-link-active pt-1" data-testid="router-link-menu">
                    <span data-v-1267300e="" data-v-0c8898ec="" data-testid="span-menu" class="mi-container radius-2 flex justify-around btn-open-cart" style="cursor: pointer;">
                        ...
                        <div data-v-1267300e="" class="mi-title font-0" style="color: rgba(255, 255, 255, 1); padding: 4px 4px;">Carrinho</div>
                    </span>
                </div>
            ...
            $(document).ready(function() {
                $('.btn-open-cart').off('click').on('click', function(e) {
                    e.preventDefault();
                    e.stopPropagation();
        ...
        @auth
            ...
            <div data-v-0c8898ec="" data-v-42af03df="">
                <div data-v-0c8898ec="" class="mi-container flex justify-around router-link-active pt-1" data-testid="router-link-menu">
                    <a href="{{ url('/') }}/meus-pedidos/" data-v-1267300e="" data-v-0c8898ec="" data-testid="span-menu"
                        class="mi-container radius-2 flex justify-around">
                        <div data-v-1267300e="" class="mi-icon">
                            <div data-v-d15b4698="" data-v-1267300e="" class="icon-container">
            ...
            <div data-v-0c8898ec="" data-v-42af03df="">
                <div data-v-0c8898ec="" class="mi-container flex justify-around router-link-active pt-1" data-testid="router-link-menu">
                    <a href="{{ url('/') }}/meus_cupons/" data-v-1267300e="" data-v-0c8898ec="" data-testid="span-menu"
                        class="mi-container radius-2 flex justify-around">
                        <div data-v-1267300e="" class="mi-icon">
                            <div data-v-d15b4698="" data-v-1267300e="" class="icon-container">
            ...
            <!-- PONTOS -->
            @if($config->config_fidelidade_ativo == 1)
            <div data-v-0c8898ec="" data-v-42af03df="">
                <div data-v-0c8898ec="" class="mi-container flex justify-around router-link-active pt-1" data-testid="router-link-menu">
                    <a href="{{ url('/') }}/fidelidadeCliente/" data-v-1267300e="" data-v-0c8898ec="" data-testid="span-menu"
                        class="mi-container radius-2 flex justify-around">
                        <div data-v-1267300e="" class="mi-icon">
                            <div data-v-d15b4698="" data-v-1267300e="" class="icon-container">
            ...
            <div data-v-0c8898ec="" data-v-42af03df="">
                <div data-v-0c8898ec="" class="mi-container flex justify-around router-link-active pt-1" data-testid="router-link-menu">
                    <a href="{{ url('/') }}/meus-dados/" data-v-1267300e="" data-v-0c8898ec="" data-testid="span-menu"
                        class="mi-container radius-2 flex justify-around">
                        <div data-v-1267300e="" class="mi-icon">
                            <div data-v-d15b4698="" data-v-1267300e="" class="icon-container">
                                @php
            ...
            <div data-v-0c8898ec="" data-v-42af03df="">
                <div data-v-0c8898ec="" class="mi-container flex justify-around router-link-active pt-1" data-testid="router-link-menu">
                    <a href="{{ url('/') }}/sair/" data-v-1267300e="" data-v-0c8898ec="" data-testid="span-menu"
                        class="mi-container radius-2 flex justify-around">
                        <div data-v-1267300e="" class="mi-icon">
                            <div data-v-d15b4698="" data-v-1267300e="" class="icon-container">
                                <!-- Ícone de Logout -->
